                                    ...
                                    <section class="section-products">
                                        ...
                                        <div class="product-list-show" style="display: none">
                                           ...
                                           <div class="product_item col-xs-12">
                                                <form action="../product/<%=p.getProductID()%>" method="post" class="product_item_form">
                                                    <div>
...
<!--                                                                    <button class="product-action btn-red addtocart add-to-cart btn btn-default btn-lg" type="submit" id="button-cart">MUA NGAY</button>-->
                                                                    <a class="btn btn-default btn-black btn-lg" href="../product/<%=p.getProductID()%>">CHI TIẾT</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="product-grid-show">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="product_item">
                                                    <form action="../product/<%=p.getProductID()%>" class="product_item_form" method="post">
