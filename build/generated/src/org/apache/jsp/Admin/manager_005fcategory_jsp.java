...
if(session.getAttribute("adid")=="noti"){
      ...
      out.write("                                              <h4 class=\"modal-title\" id=\"myModalLabel\">Bạn muốn xóa danh mục <strong>");
      out.print(category.getCategoryName());
      out.write("</strong></h4>\r\n");
      out.write("                                            </div>         \r\n");
      out.write("                                            <div class=\"modal-footer\">\r\n");
      out.write("                                              <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Hủy</button>\r\n");
      out.write("                                              <button type=\"button\" class=\"btn btn-danger\" onclick=\"location.href='../ManagerCategoryServlet?command=delete&category_id=");
      out.print(category.getCategoryID());
